...
(function() {
	...
	module.exports = L.extend(Localization, {
		...
		'vi': {
			...
			instructions: {
				'Head':
					['Đi thẳng về {dir}', ' trên {road}'],
				'Continue':
					['Tiếp tục về {dir}', ' trên {road}'],
				'SlightRight':
					['Rẽ nhẹ về phía bên phải', ' trên {road}'],
				'Right':
					['Rẽ phải', ' trên {road}'],
				'SharpRight':
					['Rẽ phải đột ngột', ' trên {road}'],
				'TurnAround':
					['Quay đầu'],
				'SharpLeft':
					['Rẽ trái đột ngột', ' trên {road}'],
				'Left':
					['Rẽ trái', ' trên {road}'],
				'SlightLeft':
					['Rẽ nhẹ về phía bên trái', ' trên {road}'],
				'WaypointReached':
					['Đã đến điểm đón'],
				'Roundabout':
					['Tại vòng xuyến, rẽ ra ở lối số {exitStr}', ' trên {road}'],
				'DestinationReached':
					['Đã đến nơi đến'],
			},
			formatOrder: function(n) {
