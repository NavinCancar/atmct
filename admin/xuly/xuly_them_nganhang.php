...
if (isset($_POST['them_atm'])) {
 ...
 if ($result->num_rows > 0) {
  ...
  $insert_sql = "INSERT INTO NGAN_HANG (NH_MA, NH_TEN, NH_DIACHI, NH_SDT, NH_VIDOX, NH_KINHDOY, XP_MA) VALUES ('$NH_MA', '$NH_TEN', '$NH_DIACHI', '$NH_SDT', '$NH_VIDOX', '$NH_KINHDOY', '$XP_MA')";
