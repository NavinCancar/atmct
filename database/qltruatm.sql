...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 13, 2024 lúc 02:56 AM
...
INSERT INTO `ngan_hang` (`NH_MA`, `XP_MA`, `NH_TEN`, `NH_DIACHI`, `NH_SDT`, `NH_VIDOX`, `NH_KINHDOY`) VALUES
(1, 4, 'Agribank', '280 Phạm Hùng', '01900558818', 9.99246, 105.74882),
(2, 3, 'Vietcombank', '3-5-7 Hòa Bình', '02923820445', 10.0336715, 105.7847596),
(3, 3, 'Sacombank', '95 Nam Kỳ Khởi Nghĩa', '02923843295', 10.0323723, 105.7841215),
(4, 9, 'HD Bank', '162-162B Trần Hưng Đạo', '02923734250', 10.0365398, 105.7758005);
...
INSERT INTO `phong_giao_dich` (`PGD_MA`, `XP_MA`, `NH_MA`, `PGD_TEN`, `PGD_DIACHI`, `PGD_SDT`, `PGD_VIDOX`, `PGD_KINHDOY`) VALUES
(1, 3, 1, 'PGD ARB số 02', '15 Đại lộ Hòa Bình', '02923852125', 10.0324317, 105.7833691),
(2, 10, 1, 'PGD ARB số 03', '155 Lý Tự Trọng', '01900558818', 10.0356814, 105.7785983),
(3, 2, 1, 'PGD VCB An Hòa', '57 Võ Văn Kiệt', '02923898179', 10.04504, 105.7631777),
(4, 8, 2, 'PDG VCB 3/2', '70 3 tháng 2', '02923680086', 10.0210231, 105.7647906),
(5, 1, 2, 'PGD VCB Ninh Kiều', '49-51 Trần Văn Khéo', '02923764849', 10.0439696, 105.7831773),
(6, 2, 3, 'PGD SCB An Hòa', '51 Cách mạng tháng 8', '02923765423', 10.0483141, 105.7769444),
(7, 9, 3, 'PGD SCB An Phú', '228G Trần Hưng Đạo', '02923730003', 10.0342843, 105.7749627),
(8, 1, 3, 'PGD SCB Cái Khế', '81-83 Trần Văn Khéo', '02923761687', 10.0448143, 105.7843475),
(9, 11, 4, 'PGD HDB Xuân Khánh', '209A-209B 30 tháng 4', '02923783041', 10.0241846, 105.7738967);
...
INSERT INTO `tru_atm` (`TA_SOHIEU`, `NH_MA`, `XP_MA`, `TA_DIACHI`, `TA_VIDOX`, `TA_KINHDOY`) VALUES
('0924777', 1, 3, 'Ngô Hữu Hạnh', 10.035795, 105.7873137),
('1543878', 3, 13, '363AA Nguyễn Văn Cừ Nối Dài', 10.0215533, 105.7430452),
('1765423', 2, 6, 'Lô 20 Phú An', 10.0053592, 105.798532),
('2176883', 3, 4, '415 Quốc Lộ 1A', 10.0001982, 105.7503835),
('5632975', 3, 7, '953/6 đường 26/03', 10.1113288, 105.6213519),
('5824633', 2, 3, 'Số 1 Đại lộ Hoà Bình', 10.0336715, 105.7847596),
('6675942', 4, 9, '162 - 162B Trần Hưng Đạo', 10.0365398, 105.7758005),
('6724987', 1, 3, 'Số 8-10 Nam Kỳ Khởi Nghĩa', 10.0317593, 105.7865143),
('8267599', 2, 12, '179 Nguyễn Văn Cừ', 10.0354, 105.757),
('9876245', 1, 11, 'Cổng B Khu II Trường Đại Học Cần Thơ 3/2', 10.0290338, 105.7711959);
...
--
ALTER TABLE `phong_giao_dich`
  ADD CONSTRAINT `FK_CO` FOREIGN KEY (`NH_MA`) REFERENCES `ngan_hang` (`NH_MA`),
  ADD CONSTRAINT `FK_CO_PHONG_GIAO_DICH` FOREIGN KEY (`XP_MA`) REFERENCES `xa_phuong` (`XP_MA`);
