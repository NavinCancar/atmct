        ...
        $(document).ready(function () {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position){
                    ...
                    //ROUTING PGD START
                    <?php
                        // Check if the necessary values are set in the $_POST array
                        if (isset($_POST['nganhangSelect']) && isset($_POST['khoangcachInput'])) {
                            $nganhangSelect = $_POST['nganhangSelect'];
                            $khoangcachInput = $_POST['khoangcachInput'];

                            // Output the JavaScript code
                            echo "console.log('pgdnganhangSelect nhận: " . $nganhangSelect . " ');";
                        } else {
                            echo "console.log('One or both values are not set.');";
                        }
                    ?>
                    <?php 
